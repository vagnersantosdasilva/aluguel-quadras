...
from app import app
from services.grade_horario_service import create_grade_horario, update_grade_horario, delete_grade_horario,get_grade_horario, get_all_grades_horario
...
def create_grade(id):
    with app.app_context():
        ...
        return create_grade_horario(id,data)


@app.route('/campo/<int:id>/grade', methods=['PUT'])
def update_grade(id):
    with app.app_context():
        data = request.get_json()
        return update_grade_horario(id, data)
